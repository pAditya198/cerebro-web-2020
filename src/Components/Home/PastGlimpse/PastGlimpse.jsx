    ...
    <div className="gallery">
      ...
      <div className="gallery__images">
        <div className="gallery__images__container">
          <div className="wide" style={{ backgroundImage: `url('./media/botrun${width <= 1000 ? '_mobile' : ''}.jpg')`}}></div>
          <div className="tall" style={{backgroundImage: `url('./media/tabletview${width<=1000 ? '_mobile' : ''}.jpg')`}}></div>
          ...
          <div className="wide" style={{ backgroundImage: `url('./media/baymax${width <= 1000 ? '_mobile' : ''}.jpeg')`}}></div>
